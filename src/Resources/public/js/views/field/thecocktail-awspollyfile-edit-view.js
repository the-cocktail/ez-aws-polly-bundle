YUI.add('thecocktail-awspollyfile-field-edit-view', function (Y) {

    Y.namespace('theCocktail');

    var FIELDTYPE_IDENTIFIER = 'ezawspollyfile';

    Y.theCocktail.AwsPollyFileEditView = Y.Base.create('awspollyfileEditView', Y.eZ.BinaryBaseEditView, [], {
    ...
    Y.eZ.FieldEditView.registerFieldEditView(
        FIELDTYPE_IDENTIFIER, Y.theCocktail.AwsPollyFileEditView
    );
});
